...
if __name__ == "__main__":
    ...
    save_path = os.path.join("experiments", "neat_single", args.env_name, args.exp_dirname)
    ...
    self_structure = Structure(os.path.join(save_path, self_robot_id), body, connections, controller_type="neat")
