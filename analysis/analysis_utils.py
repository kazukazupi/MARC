...
def get_env_name(experiment_dir: str) -> str:
    ...
    elif extract_exp_type(experiment_dir) in ["ppo", "ppo_single", "neat_single"]:
...
def extract_exp_type(experiment_dir: str) -> Literal["coea", "ppo", "ppo_single", "neat_single"]:
